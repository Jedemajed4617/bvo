...
<body>
    ...
    <div class="containerFoto">
        <div class="containerItem1 zoom-effect">
            <p class="containerP1">Visit our stores</p>
            <button class="containerB1"><a href="productspage.php">Press Here</a></button>
        </div>
        <div class="containerItem2 zoom-effect">
            <p class="containerP1">Accesories</p>
            <button class="containerB1"><a href="productspage.php">Press Here</a></button>
        </div>
    </div>
    <div class="containerFoto">
        <div class="containerItem3 zoom-effect">
            <p class="containerP1">Summer '23</p>
            <button class="containerB1"><a href="productspage.php">Press Here</a></button>
        </div>
